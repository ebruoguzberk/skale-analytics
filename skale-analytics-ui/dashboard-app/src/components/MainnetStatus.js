                  ...
                  {validator.map((obj) => (
                    ...
                    >
                      ...
                      <TableCell
                        ...
                        onClick={() => handleClick(`/mainnetstatus/${obj['Validator.id']}`)}>
                        {obj['Validator.name']}
                        &nbsp;
                      ...
                      <TableCell>{obj['ValidatorHealth.status']}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
...
MainnetStatus.propTypes = {
  className: PropTypes.string,
  query: PropTypes.object.isRequired,
};

export default MainnetStatus;
